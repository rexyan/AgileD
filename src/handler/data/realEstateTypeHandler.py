...
class RealEstateTypeHandler(BaseHandler):
    @doc.summary("获取全国楼盘分组")
    @doc.description('获取全国楼盘分组')
    ...
    async def get(self, response, **kwargs):
        ...
        filter_result = RealEstateTypeHandler.filter_es_term_bucket_value("City", search_result)
